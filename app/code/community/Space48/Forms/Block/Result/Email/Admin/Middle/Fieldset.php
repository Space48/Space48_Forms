...
class Space48_Forms_Block_Result_Email_Admin_Middle_Fieldset extends Space48_Forms_Block_Result_Fieldset_Abstract
{
    /**
     * constructor
     */
    public function _construct()
    {
        ...
        // set template
        $this->setTemplate('space48/forms/result/email/admin/fieldset/fieldset.phtml');
    }
    ...
    public function getFieldHtml(Space48_Forms_Model_Form_Result_Fieldset_Field $field)
    {
        ...
        switch ( $field->getType() ) {
            case Space48_Forms_Model_Source_Form_Fieldset_Field_Type::TYPE_TEXT:
                $block = 'space48_forms/result_email_admin_middle_fieldset_field_text';
                break;
            case Space48_Forms_Model_Source_Form_Fieldset_Field_Type::TYPE_TEXTAREA:
                $block = 'space48_forms/result_email_admin_middle_fieldset_field_textarea';
                break;
            case Space48_Forms_Model_Source_Form_Fieldset_Field_Type::TYPE_SELECT:
                $block = 'space48_forms/result_email_admin_middle_fieldset_field_select';
                break;
            case Space48_Forms_Model_Source_Form_Fieldset_Field_Type::TYPE_CHECKBOX:
                $block = 'space48_forms/result_email_admin_middle_fieldset_field_checkbox';
                break;
            case Space48_Forms_Model_Source_Form_Fieldset_Field_Type::TYPE_RADIO:
                $block = 'space48_forms/result_email_admin_middle_fieldset_field_radio';
                break;
            case Space48_Forms_Model_Source_Form_Fieldset_Field_Type::TYPE_FILE:
                $block = 'space48_forms/result_email_admin_middle_fieldset_field_file';
                break;
        }
