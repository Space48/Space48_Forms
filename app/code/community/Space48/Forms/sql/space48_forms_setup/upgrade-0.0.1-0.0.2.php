...
$sql = "
    ...
    CREATE TABLE `{$table}`(
      ...
      `email_admin_address_to` TEXT COMMENT 'Admin email address (to).',
      `email_admin_address_cc` TEXT COMMENT 'Admin email address (cc).',
      `email_admin_address_bcc` TEXT COMMENT 'Admin email address (bcc).',
      ...
      `email_customer_address_cc` TEXT COMMENT 'Customer email address (cc).',
      `email_customer_address_bcc` TEXT COMMENT 'Customer email address (bcc).',
